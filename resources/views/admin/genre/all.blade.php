...
@section('title', 'All Genre(s)')

@section('name', 'admin.genre.all')

@section('content')

    <div class="all_genre mx-auto w-fit max-w-full overflow-hidden">
        ...
        <div class="search_filter my-2 flex flex-col sm:flex-row justify-start gap-2 sm:gap-5 items-center">
            ...
            <div
                ...
                <input type="text" placeholder="Search Genre by Name" id="genre_search" name="genre_search"
        ...
        <div class="overflow-x-auto w-full customScrollbar">
            <div class="table w-fit">
                    ...
                    <x-filtered-genre :genres="$genres" />
