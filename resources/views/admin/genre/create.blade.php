...
@section('content')
    <div class="create_genre">
        <div class="form w-full sm:max-w-96 md:max-w-[450px] lg:max-w-[600px] xl:max-w-[800px] mx-auto">
            <form action="{{ route('admin.genre.create.handle') }}" method="POST" class="flex flex-col gap-8">
                @csrf
                <div class="field text-white flex flex-col gap-2">
                    <label for="name" class="lg:text-lg xl:text-xl">Name</label>
                    <input class="w-full" type="text" name="genre_name" id="genre_name" placeholder="Choose a Genre Name"
                        autocomplete="off">
                ...
                <div class="field text-white flex flex-col gap-2">
                    ...
                    <input type="text" name="genre_slug" id="genre_slug" placeholder="e.g. animation, fantasy">
                ...
                <div class="existing_genres">
                    ...
                    <div class="info mt-2 flex gap-2 text-amber-500 text-sm">
                        ...
                        <p>Make sure your genre name don't match one of those!</p>
                    </div>
                </div>
