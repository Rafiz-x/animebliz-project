...
<body data-barba="wrapper">
    ...
    <header>
        ...
        @if (SHOW_MENU)
            ...
            <div
                class="nav fixed -translate-x-[300px] top-0 left-0 max-w-[350px] h-full bg-[#161716]  text-white flex flex-col gap-2 px-5 py-2 z-[99999999]">
                <div id="closeNav"
        ...
        @if (SHOW_SEARCH)
            ...
            <div id="searchArea"
                class="fixed top-0 right-0 w-full h-[100%] bg-[#161716] z-50 p-4 md:p-6 transition-all opacity-0 overflow-y-auto">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <input type="text"
                                    class="caret-[#ff5f5f] grow bg-transparent p-2 rounded-md text-white outline-none !border-0 !ring-0"
